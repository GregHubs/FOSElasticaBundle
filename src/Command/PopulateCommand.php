...
class PopulateCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('id', null, InputOption::VALUE_OPTIONAL, 'The id of the type to populate')
            ->addOption('ids', null, InputOption::VALUE_OPTIONAL, 'The ids of the type to populate')
